...
class CubeGLWidget(QOpenGLWidget):
    ...
    def drawCube(self):
        # 繪製火箭本體 (細長的長方體，以 Y 軸為縱軸)
        gl.glBegin(gl.GL_QUADS)
        # 前面 (Z+)
        gl.glColor3f(0.3, 0.7, 0.3)  # 綠色 (用於辨識自旋正面)
        gl.glVertex3f(-0.25, -1.5,  0.25)
        gl.glVertex3f( 0.25, -1.5,  0.25)
        gl.glVertex3f( 0.25,  1.5,  0.25)
        gl.glVertex3f(-0.25,  1.5,  0.25)
        # 後面 (Z-)
        gl.glColor3f(0.95, 0.8, 0.1)  # 黃色 (背面)
        gl.glVertex3f(-0.25, -1.5, -0.25)
        gl.glVertex3f(-0.25,  1.5, -0.25)
        gl.glVertex3f( 0.25,  1.5, -0.25)
        gl.glVertex3f( 0.25, -1.5, -0.25)
        ...
        gl.glVertex3f( 0.25,  1.5, -0.25)
        # 底面 (Y-)
        gl.glColor3f(0.3, 0.3, 0.7)  # 藍色 (底座/噴口)
        gl.glVertex3f(-0.25, -1.5, -0.25)
        gl.glVertex3f( 0.25, -1.5, -0.25)
        gl.glVertex3f( 0.25, -1.5,  0.25)
        gl.glVertex3f(-0.25, -1.5,  0.25)
        ...
        # 繪製火箭鼻錐 (Nose Cone，尖角朝 Y+ 頂部)
        gl.glBegin(gl.GL_TRIANGLES)
        # 鼻錐前側
        gl.glColor3f(0.9, 0.2, 0.2)  # 紅色鼻錐
        gl.glVertex3f( 0.0,   2.1,  0.0)   # 頂點
        gl.glVertex3f(-0.25,  1.5,  0.25)
        gl.glVertex3f( 0.25,  1.5,  0.25)
        # 鼻錐右側
        gl.glColor3f(0.8, 0.15, 0.15)
        gl.glVertex3f( 0.0,   2.1,  0.0)
        gl.glVertex3f( 0.25,  1.5,  0.25)
        gl.glVertex3f( 0.25,  1.5, -0.25)
        # 鼻錐後側
